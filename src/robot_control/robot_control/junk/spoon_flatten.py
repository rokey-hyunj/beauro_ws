...
def perform_task():
    ...
    move_to_bowl = posj([31.323, 19.543, 93.295, -53.907, 59.671, 66.965])
    ...
    move_back = posx([263.624, 247.837, 215.776, 151.024, -95.058, 79.201])
    cup_up = posj([19.467, 14.651, 128.229, -99.605, 61.245, 43.261])
    pour = posj([19.468, 14.655, 128.342, -100.957, 61.739, -34.428])
    ...
    movej(move_to_bowl, vel=VELOCITY, acc=ACC)
