...
def perform_task():
    ...
    spoon_up = posj([-18.784, 17.081, 43.587, -0.374, 119.113, -18.864])
    ...
    movej(spoon_up, vel=VELOCITY, acc=ACC)
    ...
    movel(spoon_up, vel=VELOCITY, acc=ACC)


def main(args=None):
    """메인 함수: ROS2 노드 초기화 및 동작 수행"""
    rclpy.init(args=args)
    node = rclpy.create_node("pick_spoon", namespace=ROBOT_ID)
